...
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "estate_agency_back.settings")
django.setup()

from estate_agency.models import UserProfile, Realty, Deal
...
def get_realty_stats(estates: QuerySet[Realty]):
    realty_counts = {}

    for realty in estates:
        if realty.type:
